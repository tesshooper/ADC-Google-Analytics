...
```{r Extract Sorted Individual Years Top 30, echo = FALSE, message = FALSE, warning = FALSE, include = FALSE, warning = FALSE}

 
####### To try visualizations - extract individual years and take top 30 pages ########
...
```{r Visualization 1 - Total Users Over Time, echo = FALSE, warning = FALSE, include=TRUE}


### Create graphs for all Users over time
...
## Create a treemap of total Users by Year 
