...
```{r Search Terms, echo = FALSE, message = FALSE, warning = FALSE}

## Create word clouds for most used search terms 

## Using 2020 data as TEST 

# read in data
searchwords_2020 <- read.csv("/home/t_hooper/ADC-Google-Analytics/searchwords_2020.csv")
